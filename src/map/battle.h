...
extern struct Battle_Config
{
	...
	int global_short_damage_rate; // By JakeRed
	int global_long_damage_rate; // By JakeRed
	int global_weapon_damage_rate; //By JakeRed
	int global_magic_damage_rate; //By JakeRed
	int global_misc_damage_rate; //By Jake Red
